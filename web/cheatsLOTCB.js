...
function cheats()
{
    ...
    if (buildMode == true)
    {
        ...
        else if (buildToggle == 384)
        {
            if (xKey)
            {
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "Garasuwamu", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(rowal, 1470, 2280, 100, 33, -1/2 * 100, -1/2 * 33, 100, 33);
                XXX.restore();
            }
        }
        else if (buildToggle == 385)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("garasuPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("garasuPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("garasuPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 386)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("crate", ' + X + ', ' + Y + ', ' + buildRot + ', -6, [' + buildSize +']));');
                scenicList.push(new Scenery("crate", X, Y, buildRot, -6, [buildSize]));
            }

            var islonDDDD = new Scenery("crate", X, Y, buildRot, -6, [buildSize]);
            islonDDDD.operations();
        }
        else if (buildToggle == 387)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("crate", ' + X + ', ' + Y + ', ' + buildRot + ', -7, [' + buildSize +']));');
                scenicList.push(new Scenery("crate", X, Y, buildRot, -7, [buildSize]));
            }

            var islonDDDD = new Scenery("crate", X, Y, buildRot, -7, [buildSize]);
            islonDDDD.operations();
        }
        else if (buildToggle == 388)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("crate", ' + X + ', ' + Y + ', ' + buildRot + ', -9, [' + buildSize +']));');
                scenicList.push(new Scenery("crate", X, Y, buildRot, -9, [buildSize]));
            }

            var islonDDDD = new Scenery("crate", X, Y, buildRot, -9, [buildSize]);
            islonDDDD.operations();
        }
        else if (buildToggle == 389)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "SentoBug", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(rowal, 1325, 2380, 19, 19, -1/2 * 19 * 2, -1/2 * 19 * 2, 19 * 2, 19 * 2);
                XXX.restore();
            }
        }
        else if (buildToggle == 390)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "Cren", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(rowal, 403, 2364, 71, 57, -1/2 * 71, -1/2 * 57, 71, 57);
                XXX.restore();
            }
        }
        else if (buildToggle == 391)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "Vlica", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(sprea, 715, 573, 89, 42, -1/2 * 89, -1/2 * 42, 89, 42);
                XXX.restore();
            }
        }
        else if (buildToggle == 392)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("reshidWallSlime", ' + X + ', ' + Y + ', ' + buildRot + ", " + buildSize + ", " + buildClase +'));');
                scenicList.push(new Scenery("reshidWallSlime", X, Y, buildRot, buildSize, buildClase));
            }

            var islonDDDD = new Scenery("reshidWallSlime", X, Y, buildRot, buildSize, buildClase);
            islonDDDD.operations();
        }
        else if (buildToggle == 393)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("yotsoPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("yotsoPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("yotsoPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 394)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("kadzeuPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("kadzeuPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("kadzeuPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 395)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("minshiPlant", ' + X + ', ' + Y + ', ' + buildRot + ', 1));');
                scenicList.push(new Scenery("minshiPlant", X, Y, buildRot, 1));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("minshiPlant", X, Y, buildRot, 1);
            islonDDDD.operations();
        }
        else if (buildToggle == 396)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("acheguPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("acheguPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("acheguPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 397)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("caveAcheguPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("caveAcheguPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("caveAcheguPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 398)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("panpiPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("panpiPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("panpiPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 399)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("iuaPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("iuaPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("iuaPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 400)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("greenSyanjPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("greenSyanjPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("greenSyanjPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 401)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("turotanPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false));');
                scenicList.push(new Scenery("turotanPlant", X, Y, buildRot, false));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("turotanPlant", X, Y, buildRot, false);
            islonDDDD.operations();
        }
        else if (buildToggle == 402)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("tsarapatTree", ' + X + ', ' + Y + ', ' + buildRot + ', ' + buildSize + '));');
                scenicList.push(new Scenery("tsarapatTree", X, Y, buildRot, buildSize));
                buildRot = 2*Math.PI*Math.random();
                buildSize = 0.65 + (2/3 * Math.random());
            }

            var islonDDDD = new Scenery("tsarapatTree", X, Y, buildRot, buildSize);
            islonDDDD.operations();
        }
        else if (buildToggle == 403)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("burgonTree", ' + X + ', ' + Y + ', ' + buildRot + ', ' + buildSize + '));');
                scenicList.push(new Scenery("burgonTree", X, Y, buildRot, buildSize));
                buildRot = 2*Math.PI*Math.random();
                buildSize = 0.86 + (84/100 * Math.random());
            }

            var islonDDDD = new Scenery("burgonTree", X, Y, buildRot, buildSize);
            islonDDDD.operations();
        }
        else if (buildToggle == 404)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("northDeco", ' + X + ', ' + Y + ', ' + buildRot + ', ' + buildClase +', ' + buildSize +'));');
                scenicList.push(new Scenery("northDeco", X, Y, buildRot, buildClase, buildSize));
            }

            var islonDDDD = new Scenery("northDeco", X, Y, buildRot, buildClase, buildSize);
            islonDDDD.operations();
        }
        else if (buildToggle == 405)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("cavortaPlant", ' + X + ', ' + Y + ', ' + buildRot + ', true));');
                scenicList.push(new Scenery("cavortaPlant", X, Y, buildRot, true));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("cavortaPlant", X, Y, buildRot, true);
            islonDDDD.operations();
        }
        else if (buildToggle == 406)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("scruchivaniyePlant", ' + X + ', ' + Y + ', ' + buildRot + ', true));');
                scenicList.push(new Scenery("scruchivaniyePlant", X, Y, buildRot, true));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("scruchivaniyePlant", X, Y, buildRot, true);
            islonDDDD.operations();
        }
        else if (buildToggle == 407)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("klyukvaPlant", ' + X + ', ' + Y + ', ' + buildRot + ', true, ' + buildClase + '));');
                scenicList.push(new Scenery("klyukvaPlant", X, Y, buildRot, true, buildClase));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("klyukvaPlant", X, Y, buildRot, true, buildClase);
            islonDDDD.operations();
        }
        else if (buildToggle == 408)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("klyukvaPlant", ' + X + ', ' + Y + ', ' + buildRot + ', false, ' + buildClase + '));');
                scenicList.push(new Scenery("klyukvaPlant", X, Y, buildRot, false, buildClase));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("klyukvaPlant", X, Y, buildRot, false, buildClase);
            islonDDDD.operations();
        }
        else if (buildToggle == 409)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("kustPlant", ' + X + ', ' + Y + ', ' + buildRot + ', true));');
                scenicList.push(new Scenery("kustPlant", X, Y, buildRot, true));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("kustPlant", X, Y, buildRot, true);
            islonDDDD.operations();
        }
        else if (buildToggle == 410)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("krasotaPlant", ' + X + ', ' + Y + ', ' + buildRot + ', true));');
                scenicList.push(new Scenery("krasotaPlant", X, Y, buildRot, true));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("krasotaPlant", X, Y, buildRot, true);
            islonDDDD.operations();
        }
        else if (buildToggle == 411)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("quimPlant", ' + X + ', ' + Y + ', ' + buildRot + ', ' + buildClase + '));');
                scenicList.push(new Scenery("quimPlant", X, Y, buildRot, buildClase));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("quimPlant", X, Y, buildRot, buildClase);
            islonDDDD.operations();
        }
        else if (buildToggle == 412)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("milxlimPlant", ' + X + ', ' + Y + ', ' + buildRot + ', ' + buildClase + '));');
                scenicList.push(new Scenery("milxlimPlant", X, Y, buildRot, buildClase));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("milxlimPlant", X, Y, buildRot, buildClase);
            islonDDDD.operations();
        }
        else if (buildToggle == 413)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("milinPlant", ' + X + ', ' + Y + ', ' + buildRot + ', true));');
                scenicList.push(new Scenery("milinPlant", X, Y, buildRot, true));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("milinPlant", X, Y, buildRot, true);
            islonDDDD.operations();
        }
        else if (buildToggle == 414)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("claubourjePlant", ' + X + ', ' + Y + ', ' + buildRot + ', true));');
                scenicList.push(new Scenery("claubourjePlant", X, Y, buildRot, true));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("claubourjePlant", X, Y, buildRot, true);
            islonDDDD.operations();
        }
        else if (buildToggle == 415)
        {
            if (fKey)
            {
                fKey = false;
            ...
            {
                xKey = false;
                console.log('scenicList.push(new Scenery("multomPlant", ' + X + ', ' + Y + ', ' + buildRot + ', true));');
                scenicList.push(new Scenery("multomPlant", X, Y, buildRot, true));
                buildRot = 2*Math.PI*Math.random();
            }

            var islonDDDD = new Scenery("multomPlant", X, Y, buildRot, true);
            islonDDDD.operations();
        }
        else if (buildToggle == 416)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "Dreg", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(quil, 174, 345, 110, 120, -1/2 * 110 * 1, -1/2 * 120 * 1, 110 * 1, 120 * 1);
                XXX.restore();
            }
        }
        else if (buildToggle == 417)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "BristleBoar", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(brist, 1, 1, 155, 71, -1/2 * 155 * 1, -1/2 * 71 * 1, 155 * 1, 71 * 1);
                XXX.restore();
            }
        }
        else if (buildToggle == 418)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "Harpy", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(harp, 3, 2236, 546, 627, -1/2 * 546 * 1, -1/2 * 627 * 1, 546 * 1, 627 * 1);
                XXX.restore();
            }
        }
        else if (buildToggle == 419)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "Minotaur", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(minno, -145, -47, 483, 334, -1/2 * 483 * 1, -1/2 * 334 * 1, 483 * 1, 334 * 1);
                XXX.restore();
            }
        }
        else if (buildToggle == 420)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "Drech", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(toothy, 22, 0, 233, 157, -1/2 * 233 * 1, -1/2 * 157 * 1, 233 * 1, 157 * 1);
                XXX.restore();
            }
        }
        else if (buildToggle == 421)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "DuskStrider", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(vult, 627, 14, 356, 205, -1/2 * 356 * 1, -1/2 * 205 * 1, 356 * 1, 205 * 1);
                XXX.restore();
            }
        }
        else if (buildToggle == 422)
        {
            if (xKey)
            {
                var alphon = Math.random();
                ...
                xKey = false;
                console.log('ArtificialIntelligenceAccess.push(new Unit(' + X +', ' + Y + ', "BiulgerBug", ' + alphon + ', "preBuilt"));');
                worldItems.push([new Item("unitMarker", X, Y), 1]);
            }
            ...
            if (rKey)
            {
                XXX.save();
                XXX.translate(1/2 * CCC.width, 1/2 * CCC.height);
                XXX.drawImage(sluth, 3341, 203, 72, 53, -1/2 * 72 * 1, -1/2 * 53 * 1, 72 * 1, 53 * 1);
                XXX.restore();
            }
        }
    }
    ...
    if (key0)
    {
        ...
        else if (cheatcode == "tiller" || cheatcode == "tiler")
        {
            if (tiller != true)
            {
                tiller = true;
                tillerList = [{tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}, {tile: "outline"}];
            }
            else
            {
                tiller = false;
        ...
        else if (cheatcode == "startingBuff")
        {
        ...
        else if (cheatcode.toLowerCase() == "raceface")
        {
            if (player.name != "Peter")
            {
                player.race = prompt("Have you ever wanted to be obscenely offensive and paint your face to look like another race? Brought to you by the creators of Race Picker Advanced comes a new revolutionary race changing technology, RaceFace!");
            }
        }
        ...
        else if (cheatcode.toLowerCase() == "baditemday")
        {
            player.meatball = true;
        }
