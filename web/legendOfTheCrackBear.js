...
function theLegend()
{
    ...
    var developerRapidamente = true; //This must be true as well as rapidamente in order to enable super speed.
    var rapidamente = true; //This makes the character have true super speed, but this only works if the above is also true.
