...
function envPack()
{
    ...
    var vardanGraveyardEnv = new Image();
    vardanGraveyardEnv.src = ("images/vardanGraveyard.png");
    window.vardanGraveyardEnv = vardanGraveyardEnv;
...
function moonberryPack()
{
    var moonberry = new Image();
    moonberry.src = ("images/moonberry.png");
    window.moonberry = moonberry;

    moonberry.onload = function()
    {
        marcasPack();
    };
}
...
function marcasPack()
{
    var marcas = new Image();
    marcas.src = ("images/marcas.png");
...
function cavernaPack()
{
    var caverna = new Image();
    caverna.src = ("images/caverna.png");
    window.caverna = caverna;
...
//QUESTS
    quests =
    {
        ...
        aDuelForLovePlayerLove: false,
        aDuelForLovePlayerLoveAccepted: false,
        aDuelForLovePlayerSuicidio: false,
        aDuelForLovePlayerMundi: false,
        aDuelForLoveWellMeeting: false,
        aDuelForLoveAtWell: false,
        aDuelForLoveDasabReto: false,
        aDuelForLoveDasabAfter: false,
        aDuelForLoveOptions: false,
        aDuelForLoveChosen: false,
        aDuelForLoveDrug: false,
        aDuelForLoveTrain: false,
        aDuelForLoveFakeDeath: false,
        aDuelForLoveFakedDeath: false,
        aDuelForLoveDrugged: false,
        aDuelForLoveTrained: false,
        ...
        magicalDissertationArcaneMonstrositiesKilled: 0,
        magicalDissertationRiftSeen: false,
...
//this list stores the Selector Bar Class for the character builder.
    selectorList = [];
    selectorList.push(new Selector(1/2 * CCC.width - 105, 260, "race", 11)); // 0 == race selector
...
//This list holds one of each type of worn item so that the player can access the worn item stats.
    ...
    allWorn.push(new Item("ancientArmour", false)); //51
    allWorn.push(new Item("northernPlateArmour", false)); //52
    allWorn.push(new Item("purpleMageRobe", false)); //53
    allWorn.push(new Item("redMageRobe", false)); //54
    ...
    allWorn.push(new Item("nirwadenPlateArmour", false)); //78
    allWorn.push(new Item("nirwadenNobleDress", false)); //79
    allWorn.push(new Item("nirwadenNobleOutfit", false)); //80
    allWorn.push(new Item("nirwadenClothingM", false)); //81
    allWorn.push(new Item("nirwadenClothingF", false)); //82
...
//Foods (Items cooked at either a stove, an oven, or a campfire)
    ...
    foods.push(new Item("roastedGnollIntestines", false));
    ...
    foods.push(new Item("naagMeat", false));
    foods.push(new Item("voaiiSponge", false));
    foods.push(new Item("raedBeetleMeat", false));
    foods.push(new Item("xerocoleRibs", false));
    foods.push(new Item("xerocoleMeat", false));
    foods.push(new Item("roastedDesertLizardSml", false));
    foods.push(new Item("roastedDesertLizardLrg", false));
    ...
    foods.push(new Item("roastedMasmaoFungus", false));
    foods.push(new Item("boiledNasobaFungus", false));
    foods.push(new Item("rice", false));
    foods.push(new Item("kabutoMeat", false));
    foods.push(new Item("turaturaTail", false));
    foods.push(new Item("mehibTail", false));
    foods.push(new Item("pounMeat", false));
...
//Tailoring (Items crafted at a weaving, sewing, dying, etc. tailor's work bench thing)
    ...
    tailoring.push(new Item("wizardGown", false));
    tailoring.push(new Item("purpleMageRobe", false));
    tailoring.push(new Item("redMageRobe", false));
...
//Alchemy (Potions and mixtures crafted at an alchemy lab station)
    ...
    alchemy.push(new Item("driedMaleotMushroom", false));
    alchemy.push(new Item("driedPoegroonMushrooms", false));
...
//Handcrafted (things the player can do without a work station of some kind)
    ...
    handcrafted.push(new Item("ashai", false));
    ...
    handcrafted.push(new Item("wholeCuredDriedNaag", false));
    handcrafted.push(new Item("curedDriedNaag", false));
    handcrafted.push(new Item("naagMeatChunk", false));
